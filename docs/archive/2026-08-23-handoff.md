# Archived DiveFrame handoff — 2026-08-23

Historical snapshot, archived on 2026-09-06. Version numbers, release URLs,
open tasks, and migration advice below are not current instructions. See
[the active handoff](../../HANDOFF.md), [documentation index](../README.md),
and [release procedure](../RELEASE-CHANNELS.md) instead.
